...
const Header = ({fromFooter}) => {
    ...
    return(
        <div className = {mobileNav?'header-wrap-mobile':fromFooter?'header-wrap-down':'header-wrap'}>
            <img className = {mobileNav?'header-img-mobile':fromFooter?'header-img-down':'header-img'} src = './images/logo.svg' alt = 'logo'/>
            <ul className = {mobileNav?'header-list-mobile':'header-list'}>
