            ...
            <div className = 'container contacts-wrap'>
                <div className = 'contacts-adress'>
                    ...
                    <div className = 'contacts-group'>
                        ...
                        <div><span className = 'contacts-tel contacts-point'><img className = 'contacts-img' src = 'images/gps3.svg' alt = 'adress'/>м. Івано-Франківськ, вул. Надрічна 46 В <span className='contacts-hidden'>(територія Sun Lit)</span></span></div>
                    </div>
                </div>
